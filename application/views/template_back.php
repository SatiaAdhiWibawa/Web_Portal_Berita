...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url()?>assets/back/images/avengers_logo.png">
    <title>Admin Marvel Studios</title>
...
<![endif]-->
    ...
    <!-- Editor -->
    <link rel="stylesheet" href="<?php echo base_url()?>assets/back/css/lib/html5-editor/bootstrapwysihtml5.css" />
    <!-- Editor -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        <!-- Logo icon -->
                        <b><img src="<?php echo base_url()?>assets/back/images/avengers_logo.png" alt="homepage" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><img src="<?php echo base_url()?>assets/back/images/marvel.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                <!-- End Logo -->
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            <!-- Message -->
                                            <a href="#">
                                                <div class="user-img"> <img src="<?php echo base_url()?>assets/back/images/users/index.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                        ...
                        <!-- Profile -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted " href="#" data-toggle="dropdown" aria-haspopup="true" ariaexpanded="false">
                                <img src="<?php echo base_url()?>assets/back/images/users/saya.jpg" alt="user" class="profile-pic" /></a>
...
<script src="<?php echo base_url()?>assets/back/js/lib/datatables/datatablesinit.js"></script>
<!--Datatables -->

<!--Editor -->
<script src="<?php echo base_url()?>assets/back/js/lib/stickykit-master/dist/sticky-kit.min.js"></script>
