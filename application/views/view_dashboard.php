<div class="row page-titles" >
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="recent-meaasge">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img alt="..." src="<?php echo base_url()?>assets/back/images/avatar/2.jpg" class="media-object"></a>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img alt="..." src="<?php echo base_url()?>assets/back/images/avatar/3.jpg" class="media-object"></a>
                                        </div>
                                        <div class="media-body">
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2019 Marvel Studios  <a href="https://marvel.com">Marvel</a></footer>
            <!-- End footer -->